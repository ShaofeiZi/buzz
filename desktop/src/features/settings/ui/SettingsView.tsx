        ...
        <SidebarContent>
          ...
          {visibleNavGroups.map((group) => (
            <SidebarGroup key={group.labelKey}>
              ...
              <SidebarGroupContent>
                <SidebarMenu
                  aria-label={t("settings.groupAria", {
